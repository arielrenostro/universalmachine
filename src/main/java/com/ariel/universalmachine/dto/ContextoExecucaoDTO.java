...
/**
 * {@link ContextoExecucaoDTO} tem por finalidade definir uma classe de transferência de dados do contexto de
 * execução
 *
 * @author ariel
 */
public class ContextoExecucaoDTO implements Serializable {
	...
	private List<String> instrucoes = new ArrayList<>(); // Usar mais tarde para mostrar as isntrucoes que serao
															// executadas
